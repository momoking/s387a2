...
public class PersonManager {
    ...
    private void load() {
        /**
         * Here, normally we would load the data from mysql person table
         * but for the sake of simplicity, I would simulate the loading by filling my obj list like so:
         */
